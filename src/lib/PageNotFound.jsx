            ...
            <div className="max-w-md w-full">
                <div className="text-center space-y-6">
                    ...
                    {isFetched && authData.isAuthenticated && authData.user?.role === 'admin' && (
                        <div className="mt-8 p-4 bg-[#111827] rounded-lg border border-white/10">
                    ...
                    <div className="pt-6">
                        <button 
                            ...
                            className="inline-flex items-center px-4 py-2 text-sm font-medium text-black bg-amber-500 rounded-lg hover:bg-amber-600 transition-colors duration-200"
                        >
